...
export default async function TenantUsersPage({
  ...
  if (!auth || !isItAdminPlatformRole(auth.platformRole) || !hasItAdminPermission(auth.platformRole, "user_role_manage")) {
    return (
  ...
  return <TenantSectionConsole tenantId={tenantId} section="users" platformRole={auth.platformRole} />;
}
